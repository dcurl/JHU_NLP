...
library(stringr) # To pull word from vector, didn't end up needing this
...
```
## Step 5: Export Data for Shiny App
```{r prep_and_export_data}
...
## Step 6: In House Testing (Allows for larger ngrams)
```{r}
# Example
phrase <- "Once Upon a"
